...
RSpec.describe ShortenersController, type: :controller do
  ...
  describe "GET #new" do
    it "assigns a new shortener as @shortener" do
      ...
      expect(assigns(:shortener)).to be_a_new(Shortener)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created shortener as @shortener" do
        post :create, {:shortener => valid_attributes}, valid_session
        expect(assigns(:shortener)).to be_a(Shortener)
        expect(assigns(:shortener)).to be_persisted
      end

      it "redirects to the created shortener" do
        post :create, {:shortener => valid_attributes}, valid_session
        expect(response).to redirect_to(Shortener.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved shortener as @shortener" do
        post :create, {:shortener => invalid_attributes}, valid_session
        expect(assigns(:shortener)).to be_a_new(Shortener)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested shortener" do
        shortener = Shortener.create! valid_attributes
        put :update, {:id => shortener.to_param, :shortener => new_attributes}, valid_session
        shortener.reload
      ...
      it "redirects to the shortener" do
        shortener = Shortener.create! valid_attributes
        put :update, {:id => shortener.to_param, :shortener => valid_attributes}, valid_session
        expect(response).to redirect_to(shortener)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the shortener as @shortener" do
        shortener = Shortener.create! valid_attributes
        put :update, {:id => shortener.to_param, :shortener => invalid_attributes}, valid_session
        expect(assigns(:shortener)).to eq(shortener)
      end
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the shorteners list" do
      shortener = Shortener.create! valid_attributes
      delete :destroy, {:id => shortener.to_param}, valid_session
      expect(response).to redirect_to(shorteners_url)
    end
  end
